...
<body>
  ...
  <div class="table-wrapper">
    <table class="fl-table">
      <caption align="bottom" style="text-align: center;font-size: x-large;">Customers</caption>
      <thead>
        <tr>
          <th>Id</th>
          <th>Name</th>
      ...
      <tbody>
        ...
        if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
            echo "<tr><td>" . $row["Id"] . "</td><td>" . $row["Username"] . "</td><td>" . $row["Email-id"] . "</td><td>" . "Rs. " . $row["Balance"] . "</td></tr>";
          }
        } else {
          echo "0 results";
        }
